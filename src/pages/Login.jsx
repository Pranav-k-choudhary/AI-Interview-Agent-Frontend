...
import { Mail, Lock, Eye, EyeOff, KeyRound, AlertCircle, ArrowRight } from 'lucide-react';
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
            Sign in to continue your placement interview preparation.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center">
              ...
              <Link
                to="/forgot-password"
                className="text-xs font-semibold text-primary-500 hover:text-primary-400 hover:underline"
              >
                Forgot Password?
              </Link>
            </div>
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className={`w-full pl-10 pr-10 py-3 rounded-xl border bg-slate-50 dark:bg-dark-800 text-sm focus:outline-none transition-all duration-205 ${
                  errors.password
                    ? 'border-red-500 focus:ring-1 focus:ring-red-500'
                    : 'border-slate-200 dark:border-dark-700 focus:border-primary-500 dark:focus:border-primary-600 focus:ring-1 focus:ring-primary-500'
                }`}
